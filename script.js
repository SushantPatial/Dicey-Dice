document.getElementById("btn").onclick = function()
{
  ...
  document.getElementById("die1").src = "https://sushantpatial.github.io/Dicey-Dice/images/dice" + randomNo1 + ".png";
  document.getElementById("die2").src = "https://sushantpatial.github.io/Dicey-Dice/images/dice" + randomNo2 + ".png";
